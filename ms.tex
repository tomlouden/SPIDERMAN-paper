...
The simplest physical model that one construct.
...
Fortunately, the phasing of the observations is such that the three visits cover very different ranges of the phase curve, which serves to alleviate the degeneracy.
